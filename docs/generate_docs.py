...
def generate_api_docs():
    ...
    cmd = (
        f"python -m sphinx.ext.apidoc -o api -H 'API Ref.' {project_root}/nobitex --force --separate"
    ...
    # Fix module paths to include nobitex prefix
...
def fix_module_paths(api_dir):
    """Fix module paths in generated RST files to include nobitex prefix."""
    replacements = []
...
This section contains example notebooks that demonstrate various features and use cases of the Nobitex Python SDK.
